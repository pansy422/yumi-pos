...
export const DEFAULT_TEMPLATE: ReceiptTemplate = {
  ...
  blocks: [
    ...
    { id: 'b_doctype', type: 'text', value: 'COMPROBANTE DE VENTA - NO TRIBUTARIO', align: 'center' },
    { id: 'b_tag', type: 'text', value: '#{{number}}', align: 'center' },
  ...
  },
  {
    ...
    template: {
      ...
      blocks: [
        ...
        { id: 'c_doctype', type: 'text', value: 'COMPROBANTE DE VENTA - NO TRIBUTARIO', align: 'center' },
  ...
  },
  {
    ...
    template: {
      ...
      blocks: [
        ...
        { id: 'i_doctype', type: 'text', value: 'COMPROBANTE DE VENTA - NO TRIBUTARIO', align: 'center' },
